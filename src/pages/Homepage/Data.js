export const homeData={
    ...
    img:'images/cardmobileslant.png',
    imgStart:'',
    alt1:'da',
    alt2:'da',
}
...
export const homeData5={
    ...
    description: 'Our mobile app makes it easier for you to buy units without'+
                   ...
                   'you an opportunity for better offers and rewards. Get our app today!',
    showButton: true,
    buttonLabel:['Google play','App store'],
    smallImage:'images/twocircle.png',
    img:'images/buyenergyportrait.png',
    imgStart:'',
    alt1:'da',
    alt2:'da',
}